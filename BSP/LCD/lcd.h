...
#define RST_L 	HAL_GPIO_WritePin(GPIOC,GPIO_PIN_9,GPIO_PIN_RESET)
#define RST_H 	HAL_GPIO_WritePin(GPIOC,GPIO_PIN_9,GPIO_PIN_SET)
					  
#define NWR_L 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_5,GPIO_PIN_RESET)
#define NWR_H 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_5,GPIO_PIN_SET)
					  
#define NRD_L 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_4,GPIO_PIN_RESET)
#define NRD_H 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_4,GPIO_PIN_SET)
		
#define NRS_L 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_13,GPIO_PIN_RESET)
#define NRS_H 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_13,GPIO_PIN_SET)

#define NCS_L 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_7,GPIO_PIN_RESET)
#define NCS_H 	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_7,GPIO_PIN_SET)
//LCD重要参数集
typedef struct  
{										    
	u16 width;			//LCD 宽度
